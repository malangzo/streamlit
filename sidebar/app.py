...
user_password = st.sidebar.text_input('비밀번호(Password) 입력', value='abcd', type='password')
...
image_files = ['https://github.com/malangzo/streamlit/blob/main/sidebar/data/Vermeer.png?raw=true', 
               'https://github.com/malangzo/streamlit/blob/main/sidebar/data/Gogh.png?raw=true', 
               'https://github.com/malangzo/streamlit/blob/main/sidebar/data/Munch.png?raw=true', 
               'https://github.com/malangzo/streamlit/blob/main/sidebar/data/ShinYoonbok.png?raw=true']
